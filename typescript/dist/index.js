...
function showTypes<T1 = undefined, T2 = undefined, T3 = undefined>(input1? : T1, input2? : T2, input3? : T3) {
    return `${input1 ? input1 : 'Nothing'} - ${input2 ? input2 : 'Nothing'} - ${input3 ? input3 : 'Nothing'}`
}
// Do Not Edit Here
